    ...
    <div className="openregio-public-page" data-testid="page-disclaimer">
      ...
      <div className="openregio-public-content">
        ...
        <section className="openregio-public-card">
          <h2><AlertTriangle className="w-4 h-4" style={{ color: "#0b2240" }} /> Algemeen</h2>
          <p>
        ...
        <section className="openregio-public-card">
          <h2><Scale className="w-4 h-4" style={{ color: "#0b2240" }} /> Aansprakelijkheid</h2>
          <p>
        ...
        <section className="openregio-public-card">
          <h2><FileText className="w-4 h-4" style={{ color: "#0b2240" }} /> Intellectueel eigendom</h2>
          <p>
        ...
        <section className="openregio-public-card">
          <h2><ShieldAlert className="w-4 h-4" style={{ color: "#0b2240" }} /> RegioBot en AI-diensten</h2>
          <p>
        ...
        <section className="openregio-public-card">
          <h2><Globe className="w-4 h-4" style={{ color: "#0b2240" }} /> Links naar derden</h2>
          <p>
        ...
        <section className="openregio-public-card">
          <h2><Scale className="w-4 h-4" style={{ color: "#0b2240" }} /> Toepasselijk recht</h2>
          <p>
